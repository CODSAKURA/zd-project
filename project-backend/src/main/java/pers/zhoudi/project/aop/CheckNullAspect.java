package pers.zhoudi.project.aop;
...
import pers.zhoudi.project.constant.ExceptionEnum;
import pers.zhoudi.project.domain.entity.Brand;
import pers.zhoudi.project.exception.BusinessException;
...
public class CheckNullAspect {
    ...
    @Pointcut("execution(* pers.zhoudi.project.domain.service.BrandDomainService.*Brand(..)) || " +
            "execution(* pers.zhoudi.project.domain.service.UserDomainService.*User(..))")
