...
import pers.zhoudi.project.domain.entity.Log;
import pers.zhoudi.project.domain.service.LogDomainService;
...
public class LoggerAspect {
    ...
    @Pointcut("execution(* pers.zhoudi.project.domain.service.*.*(..)) && !execution(* pers.zhoudi.project.domain.service.LogDomainService.*(..))")
